...
func TestMarshalUnmarshalBlockIterator(t *testing.T) {
	v := BlockIterator{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgBlockIterator(b *testing.B) {
	v := BlockIterator{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgBlockIterator(b *testing.B) {
	v := BlockIterator{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalBlockIterator(b *testing.B) {
	v := BlockIterator{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeBlockIterator(t *testing.T) {
	v := BlockIterator{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
...
func BenchmarkEncodeBlockIterator(b *testing.B) {
	v := BlockIterator{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeBlockIterator(b *testing.B) {
	v := BlockIterator{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkMarshalMsgRPCRequest(b *testing.B) {
	v := RPCRequest{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgRPCRequest(b *testing.B) {
	v := RPCRequest{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalRPCRequest(b *testing.B) {
	v := RPCRequest{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func BenchmarkDecodeRPCRequest(b *testing.B) {
	v := RPCRequest{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkMarshalMsgRPCResponse(b *testing.B) {
	v := RPCResponse{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgRPCResponse(b *testing.B) {
	v := RPCResponse{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalRPCResponse(b *testing.B) {
	v := RPCResponse{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func BenchmarkDecodeRPCResponse(b *testing.B) {
	v := RPCResponse{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func TestMarshalUnmarshalSyncStatus(t *testing.T) {
	v := SyncStatus{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgSyncStatus(b *testing.B) {
	v := SyncStatus{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgSyncStatus(b *testing.B) {
	v := SyncStatus{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalSyncStatus(b *testing.B) {
	v := SyncStatus{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func BenchmarkEncodeSyncStatus(b *testing.B) {
	v := SyncStatus{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeSyncStatus(b *testing.B) {
	v := SyncStatus{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func TestMarshalUnmarshalTokenTransfer(t *testing.T) {
	v := TokenTransfer{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgTokenTransfer(b *testing.B) {
	v := TokenTransfer{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgTokenTransfer(b *testing.B) {
	v := TokenTransfer{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalTokenTransfer(b *testing.B) {
	v := TokenTransfer{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeTokenTransfer(t *testing.T) {
	v := TokenTransfer{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
...
func BenchmarkEncodeTokenTransfer(b *testing.B) {
	v := TokenTransfer{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeTokenTransfer(b *testing.B) {
	v := TokenTransfer{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
